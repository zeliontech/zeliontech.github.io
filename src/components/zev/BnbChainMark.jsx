// The BNB Chain symbol, used only to identify the network a proof is
// anchored on. Geometry is the official mark as published by BNB Chain
// (docs.bnbchain.org/assets/bnb.svg, kept in assets-source/bnb), in the
// brand's own gold (#F0B90B) at the owner's request, so it reads exactly as
// the BNB Chain sign. Using the network's mark does not imply endorsement
// by, or a partnership with, Binance or BNB Chain.
export const BNB_GOLD = "#F0B90B";

const BnbChainMark = ({ className = "", title = "BNB Smart Chain", ...rest }) => (
  <svg
    viewBox="0 0 96 96"
    role="img"
    aria-label={title}
