              ...
              <Reveal>
                ...
                <div style={{ display:"flex", flexDirection:"column", gap:".5rem" }}>
                  {[
                    ...
                    { icon:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="16" height="16"><path d="m22 2-7 20-4-9-9-4 20-7z"/><path d="M22 2 11 13"/></svg>, label:"Telegram", val:"Join our channel", href:"https://t.me/zelionglobal" },
                    { icon:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" width="16" height="16"><path d="M4 4l16 16M4 20L20 4"/></svg>, label:"X / Twitter", val:"Follow us on X", href:"https://x.com/zelion_tech" },
