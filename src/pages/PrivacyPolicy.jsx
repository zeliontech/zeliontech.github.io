      ...
      <main className="pt-24">
        ...
        <section className="pb-28 relative">
          <div className="max-w-3xl mx-auto px-6 space-y-6">
            ...
            <motion.section
              {...sectionMotion(0.05)}
              className="relative bg-white rounded-2xl border border-primary/15 shadow-[0_10px_40px_rgba(15,40,70,0.08)] p-8 sm:p-10 overflow-hidden"
            >
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent" />
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                <p>
            ...
            >
              <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent" />
              <h2 className="mb-3 font-heading font-bold text-slate-900 text-xl">
                1. Who We Are
              </h2>
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                <p>
                ...
                <ul className="mt-3 space-y-2 pl-5 list-disc">
                  <li>Website: <a href="https://zeliontech.com" className="text-primary hover:underline">https://zeliontech.com</a></li>
                  <li>Contact Email: <a href="mailto:info@zeliontech.com" className="text-primary hover:underline">info@zeliontech.com</a></li>
                </ul>
              </div>
            </motion.section>
            ...
            >
              ...
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                ...
                <div className="mt-4">
                  <h3 className="mb-2 font-heading text-base font-semibold text-slate-900">
                    Contact Form
                  </h3>
                  <p>We may collect:</p>
            ...
            >
              ...
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                ...
                <p className="mt-4 font-kanit font-semibold text-slate-900">
            ...
            >
              ...
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                ...
                <p className="mt-4">
                  ...
                  <a href="mailto:info@zeliontech.com" className="text-primary hover:underline">
                    info@zeliontech.com
                  </a>
                </p>
              </div>
            ...
            >
              ...
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                ...
                <div className="mt-4">
                  ...
                  <p>
                    We process analytics data based on our <strong className="font-semibold text-slate-900">legitimate interest</strong> in understanding
            ...
            >
              ...
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                ...
                <ul className="mt-3 space-y-2 pl-5 list-disc">
                  <li>
                    <strong className="font-semibold text-slate-900">Google Firebase:</strong> For analytics, data storage, and hosting services
                  </li>
                  <li>
                    <strong className="font-semibold text-slate-900">Cloud Infrastructure Providers:</strong> For website hosting and data storage
                  </li>
                </ul>
            ...
            >
              ...
              <div className="font-kanit font-light text-slate-900/60 leading-relaxed">
                ...
                <ul className="mt-3 space-y-2 pl-5 list-disc">
                  <li>Email: <a href="mailto:info@zeliontech.com" className="text-primary hover:underline">info@zeliontech.com</a></li>
                  <li>Website: <a href="https://zeliontech.com" className="text-primary hover:underline">https://zeliontech.com</a></li>
                </ul>
              </div>
            </motion.section>
